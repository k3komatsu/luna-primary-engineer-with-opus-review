# Ponytail integration in v6.7.1
...
A globally injected Ponytail plugin can contaminate roles that are deliberately meant to be independent. For strict v6.7.1 behavior, use this package's private integration rather than global injection during Luna Primary Engineer sessions.
